...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype.updateHeaderFooter = function () {
        if (this.nativeViewProtected && this.nativeViewProtected.layout) {
            ...
            var tempView = this.getViewForViewType(commonModule.ListViewViewType.GroupView) || this.getViewForViewType(commonModule.ListViewViewType.HeaderView);
            if (tempView) {
    ...
    RadListView.prototype.getScrollOffset = function () {
        ...
        if (this.listViewLayout.scrollDirection === commonModule.ListViewScrollDirection.Vertical) {
            return this.nativeViewProtected.contentOffset.y + this.nativeViewProtected.safeAreaInsets.top;
        }
        else {
            return this.nativeViewProtected.contentOffset.x + this.nativeViewProtected.safeAreaInsets.left;
        }
    };
